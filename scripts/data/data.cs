...
public static class data
{
    ...
    public static pieceType bTBlock = new(3, 2, tiles = new tileSet[,] { { common, null }, { common, common }, { common, null } },"T Block", Colors.White);
    public static pieceType bLBlockR = new(2, 3, tiles = new tileSet[,] { { common, common, common }, { common, null, null } }, "Right L Block", Colors.White);
    public static pieceType bLBlockL = new(2, 3, tiles = new tileSet[,] { { common, null, null }, { common, common, common } }, "Left L Block", Colors.White);
    ...
    public static pieceType bZBlockL = new(2, 3, tiles = new tileSet[,] { { common, common, null }, { null, common, common } }, "Left Z Block", Colors.White);
